...
class _ProductFormPageState extends State<ProductFormPage> {
  ...
  bool validateImageUrl(String url) {
    ...
    bool urlEndsWith = url.toLowerCase().endsWith('png') ||
        url.toLowerCase().endsWith('jpg') ||
        url.toLowerCase().endsWith('jpeg');

    return isValid && urlEndsWith;
  }
    ...
    try {
      ...
      await showDialog<void>(
          ...
          builder: (ctx) => AlertDialog(
                title: const Text('Ocoreu um erro ao salvar o produto.'),
                actions: [
                  TextButton(
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (description.trim().length < 5) {
                            return 'A descrição precisa ter, no mínimo, 5 caracteres.';
                          }
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                ...
                                if (!validateImageUrl(imageUrl)) {
                                  return 'Informe um link de imagem válido!';
                                }
                                return null;
                              },
                            ),
